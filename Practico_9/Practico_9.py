...
cv2.imwrite('Resultado.jpg',imgOutP)

cv2.line(imgOutP, (152,710), (149,895), (0,195,255))
metros=medida(152,710,149,895)
cv2.putText( imgOutP , str(metros)+"mt", (162, 775), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0,195,255), 2 , cv2.LINE_AA)

cv2.line(imgOutP, (1383,847), (1198,838), (0,195,255))
metros=medida(1383,847,1198,838)
cv2.putText( imgOutP , str(metros)+"mt", (1253, 838), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0,195,255), 2 , cv2.LINE_AA)
...
while(1):
	...
	if k==ord('h') and guardar==True: #Aplico Transformacion euclidiana y guardo imagen
		...
		imgOutP=cv2.imread('Resultado.jpg',1)
		print("Imagen Restaurada")
	elif k==27 or k==ord('q'): #Salir
		break	
